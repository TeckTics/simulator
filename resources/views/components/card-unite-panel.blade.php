...
class="fixed top-0 left-0 z-30 items-end sm:items-center justify-center hidden w-full h-full overflow-x-hidden overflow-y-auto bg-black/20">
    <div class="panel-size">
        <div class="flex items-center justify-between p-4 border-b border-gray-600 rounded-t md:p-5">
            ...
            <button type="button"  name="card-unite-panel"
        ...
        <div
            class="relative w-full col-span-2 p-4 text-sm h-fit max-w-96">
           <div class=" bg-white w-full h-[225px]">
            <img class="object-cover w-full h-full rounded-t-xl" id="unite-detail-image" src="" alt="product image" />
           </div>
            <div>
                <h5 class="text-sm font-bold tracking-tight text-center uppercase text-stone-800 ">
                </h5>
                <div class="flex flex-col w-full border-t ">
                    <div class="flex items-center justify-between gap-2 px-4 py-2 border-b">
                        ...
                        <div class="flex items-center gap-1">
                            <span class="text-sm font-medium text-white" id="unite-detail-name"></span>
                    ...
                    {{-- @if ($unite->nom != $unite->nom_unite)
                        <div class="flex items-center justify-between gap-2 py-2 border-b">
                            <span class="text-sm font-semibold text-primary" id="unite-detail-personal-name">Nom de unité:</span>
                            <span class="text-sm font-medium text-secondary"></span>
                        </div>
                    @endif --}}
                    <div class="flex items-center justify-between gap-2 px-4 py-2 border-b">
                        <span class="text-sm font-semibold text-white">Type:</span>
                        <span class="text-sm font-medium text-white" id="unite-detail-type-unite"></span>
                    </div>

                    <div class="px-4 py-2 border-b ">
                        <span class="text-sm font-semibold text-white">Description:</span>
                        <p class="p-1 text-sm font-thin text-white" id="unite-detail-description"></p>
                    </div>
                    <div class="flex items-center justify-between gap-2 px-4 py-2 border-b">
                        <span class="text-sm font-semibold text-white">Vitesse de déplacement:</span>
                        <span class="text-sm font-medium text-white" id="unite-detail-speed"></span>
                    </div>
                    <div class="flex items-center justify-between gap-2 px-4 py-2 border-b">
                        <span class="text-sm font-semibold text-white">Usure:</span>
                        <span class="text-sm font-medium text-white" id="unite-detail-usure"></span>
                    </div>
                    <div class="flex items-center justify-between gap-2 px-4 py-2 border-b">
                        <span class="text-sm font-semibold text-white">Nbr Places:</span>
                        <span class="text-sm font-medium text-white" id="unite-detail-places"></span>
                    </div>
               
                    <div class="flex items-center justify-between gap-2 px-4 py-2 border-b">
                        <span class="text-sm font-semibold text-white">Position actuelle</span>
                        <span class="text-sm font-medium text-white" id="unite-detail-position"></span>
                    </div>
                    <div class="flex items-center justify-between gap-2 px-4 py-2 border-b">
                        <span class="text-sm font-semibold text-white">Santé</span>
                        <span class="text-sm font-medium text-white" id="unite-detail-sante"></span>
                    </div>
                </div>
            </div>
        </div>
        <div id="loader-detail-unite"
