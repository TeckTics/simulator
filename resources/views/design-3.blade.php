...
<body>
    ...
    <main class="">
        ...
        <section style="   justify-content: center; padding-top: 100px; position: relative;"
            ...
            <div
                class="bg-gradient-to-t absolute bottom-0 left-0 w-full h-full via-red-500/20 from-red-900/80  to-transparent">
            </div>
        ...
        <div class="bg-red-900 min-h-screen flex justify-center items-center">
            <section class="container-xl  px-5 m-auto  row" style="min-height: 40vh; ">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-4 gap-4">
                    <div
                        class=" rounded-md p-4  items-center bg-gradient-to-tr bg-white shadow-xl hover:-translate-y-2 transition-transform  hover:shadow-2xl">
                        <div class="flex justify-center gap-4 flex-col h-full">
                            <h3 class="text-stone-600 text-xl font-semibold text-center">Simuler des missions</h3>
                            <p class="p-2 text-center text-sm text-stone-600">
                    ...
                    <div
                        class=" rounded-md p-4 bg-gradient-to-tr bg-white items-center shadow-xl hover:-translate-y-2 transition-transform  hover:shadow-2xl">
                        <div class="flex justify-center gap-4 flex-col h-full">
                            <h3 class="text-stone-600 text-xl font-semibold text-center">Gérer vos ressources</h3>
                            <p class="p-2 text-center text-sm text-stone-600">
                    ...
                    <div
                        class=" rounded-md p-4 bg-gradient-to-tr bg-white items-center shadow-xl hover:-translate-y-2 transition-transform  hover:shadow-2xl">
                        <div class="flex justify-center gap-4 flex-col h-full">
                            <h3 class="text-stone-600 text-xl font-semibold text-center">Jouez en coopération avec vos
                                amis.
                            </h3>
                            <p class="p-2 text-center text-sm text-stone-600">
                    ...
                    <div
                        class=" rounded-md p-4 bg-gradient-to-tr bg-white items-center shadow-xl hover:-translate-y-2 transition-transform  hover:shadow-2xl">
                        <div class="flex justify-center gap-4 flex-col h-full">
                            <h3 class="text-stone-600 text-xl font-semibold text-center">Une puissante intelligence
                                artificielle</h3>
                            <p class="p-2 text-center text-sm text-stone-600">
