        ...
        <div class=" min-h-screen bg-blue-50" style="background-color: #1b1b1b;">
            ...
            <div class="fixed z-40 top-0 flex items-center justify-center w-full h-full p-3 md:p-0">
                <div class="bg-white text-center rounded-2xl p-8 max-w-md">
                    ...
                    <P>
                        <span class="text-2xl text-blue-700 font-semibold">Félicitations pour votre inscription sur UrgenceSAMU.</span> <br> 
                        {{-- <span class="text-sm">Pour valider votre inscription , merci de cliquer sur lien envoyé sur le mail indiqué lors de l'inscription</span> --}}
                        <span class="text-sm">Vérifiez votre boîte mail (y compris les spams) et cliquez sur le lien pour confirmer votre inscription.</span>
                    </P>
                    <P class="mt-4">  
                        {{-- hover:text-blue-700 --}}
                        <a href="{{ url('/connexion') }}" class="text-sm font-semibold rounded-md text-black border border-blue-700 p-2 hover:bg-blue-700 hover:text-white">
                            Page de connexion
                        </a>
                    </P>
                </div>
