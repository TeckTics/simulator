...
<body>
    ...
    <main class="">
        ...
        <section style="   justify-content: center; padding-top: 100px; position: relative;"
            ...
            <div
                class="bg-gradient-to-t absolute bottom-0 left-0 w-full h-full via-gray-500/50 from-gray-900/80  to-transparent">
            </div>
        ...
        <div class="bg-gray-900 min-h-screen pb-8 flex justify-center items-center">
                    ...
                    <div
                        ...
                        <div class="flex justify-center gap-4 flex-col h-full">
                            ...
                            <p class="p-2 text-center text-sm text-white">
                                ...
                                besoin
                                urgent de SAMU sur place... Plongez dans l&apos;univers d&apos;{{ $setting->nom_app }}.
                            </p>
                        </div>
                    </div>
