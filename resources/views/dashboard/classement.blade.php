...
@section('content')
    <section class="p-4 ">
        <h3 class="mt-4 text-2xl text-[#151b28]  font-bold">Classement des utilisateur</h3>
        <div class="mt-4">
            <button class="text-sm px-3 py-2 bg-[#1a2539] hover:bg-[#151b28] text-white"> Classement par interventions</button>
